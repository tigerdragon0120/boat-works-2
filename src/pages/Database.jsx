...
export default function Database(){
 ...
 return <div className="space-y-3">
  ...
  {tab==='terms'&&<select value={selectedTerm} onChange={e=>setSelectedTerm(e.target.value)} className="w-full h-11 px-3 rounded-xl bg-[#161a22] border border-[#2d3748] text-sm text-slate-200">{termKeys.map(k=><option key={k} value={k}>{k}</option>)}</select>}
